...
describe('AttemptService', () => {
	...
	describe('saveAttempt', () => {
		...
		it('should set submittedAt to current time if not provided', async () => {
			...
			const created = vi.mocked(AttemptModel.create).mock.calls[0][0] as { submittedAt: Date };
	...
	describe('getAttemptHistory', () => {
		...
		it('should enforce pagination limits', async () => {
			...
			vi.mocked(AttemptModel.find).mockReturnValueOnce(chainMin as never).mockReturnValueOnce(chainMax as never);
